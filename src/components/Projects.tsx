              ...
              <div className="group bg-gradient-to-br from-blue-500/10 to-purple-500/10 relative backdrop-blur-md rounded-xl shadow-lg overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 h-96">
                ...
                <div className="h-full flex flex-col">
                  <div className="p-6 flex-grow flex flex-col" onClick={() => toggleExpand(project.title)}>
                    ...
                    <div className={`${expandedProject === project.title ? 'opacity-50' : 'opacity-100'} group-hover:opacity-50 transition-opacity duration-300 absolute inset-0 flex items-center justify-center`}>
                      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtnvAOajH9gS4C30cRF7rD_voaTAKly2Ntaw&s"
                        alt=""
                        className="object-contain w-full rounded-xl opacity-50"
                      />
                      <span className={`${expandedProject === project.title ? "opacity-0" : "opacity-100" } text-center text-4xl font-bold cursor-default absolute group-hover:opacity-0`}>
                        {project.title}
                      </span>
                    </div>
